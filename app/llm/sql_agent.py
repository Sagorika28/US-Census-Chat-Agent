...
22. JOINS: If a question requires data from MULTIPLE views (e.g. "states with highest commute AND highest rent burden"), you MAY JOIN views on the STATE column. Both views must be from the same year. Only JOIN views listed above. Set "view" to a comma-separated list of all views used.
